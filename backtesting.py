...
def run_backtesting(tickers, weights, benchmark_ticker='^GSPC', global_etf_ticker='ACWI', start='2015-01-01', end='2023-01-01'):
    ...
    # Vykreslení kumulativní návratnosti
